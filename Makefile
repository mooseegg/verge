...
pkgdatadir = $(datadir)/verge
pkgincludedir = $(includedir)/verge
pkglibdir = $(libdir)/verge
pkglibexecdir = $(libexecdir)/verge
...
CONFIG_HEADER = $(top_builddir)/src/config/verge-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/build-aux/missing \
	$(top_srcdir)/src/config/verge-config.h.in COPYING \
...
ACLOCAL = ${SHELL} /home/coinharvest/VERGE/src/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/coinharvest/VERGE/src/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/coinharvest/VERGE/src/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/coinharvest/VERGE/src/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/coinharvest/VERGE/src/build-aux/missing makeinfo
MAKENSIS = 
MKDIR_P = /bin/mkdir -p
MOC = /usr/bin/moc
...
OTOOL = 
PACKAGE = verge
PACKAGE_BUGREPORT = https://github.com/vergecurrency/VERGE/issues
PACKAGE_NAME = VERGE Core
PACKAGE_STRING = VERGE Core 4.0.1
PACKAGE_TARNAME = verge
PACKAGE_URL = http://VERGEcurrency.com/
...
ZLIB_CFLAGS = 
ZLIB_LIBS = -lz
abs_builddir = /home/coinharvest/VERGE
abs_srcdir = /home/coinharvest/VERGE
abs_top_builddir = /home/coinharvest/VERGE
abs_top_srcdir = /home/coinharvest/VERGE
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_OBJC = gcc
ac_ct_OBJCXX = g++
...
install_sh = ${SHELL} /home/coinharvest/VERGE/src/build-aux/install-sh
...
SUBDIRS = tor src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/VERGEd$(EXEEXT)
...
OSX_INSTALLER_ICONS = $(top_srcdir)/src/qt/res/icons/verge.icns
OSX_PLIST = $(top_srcdir)/share/qt/Info.plist #not installed
OSX_QT_TRANSLATIONS = da,de,es,hu,ru,uk,zh_CN,zh_TW
DIST_DOCS = $(wildcard doc/*.md) $(wildcard doc/release-notes/*.md)
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/verge.ico \
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/verge.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/VERGE-Qt
...
src/config/verge-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/verge-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/verge-config.h
$(top_srcdir)/src/config/verge-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/verge-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/Resources/verge.icns: $(OSX_INSTALLER_ICONS)
	$(MKDIR_P) $(@D)
	$(INSTALL_DATA) $< $@

$(OSX_APP)/Contents/MacOS/VERGE-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(OSX_DMG): $(OSX_APP_BUILT) $(OSX_PACKAGING)
	...
	$(GENISOIMAGE) -no-cache-inodes -l -probe -V "VERGE-Qt" -no-pad -r -apple -o $@ dist
